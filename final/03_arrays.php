...
// Strings as keys or Associative array
$hex = [
  'red' => '#f00',
  'green' => '#0f0',
  'blue' => '#00f',
...
for ($index = 0; $index < count($namesArr); $index++){
    $element = $namesArr[$index]; // Access the element at the current index
    echo $element * 2;
}

$arrowFunc = fn($n1, $n2) => $n1 * $n2;
